...
export const ChangePhonePage: React.FC<ChangePhonePageProps> = ({ onClose }) => {
  ...
  return (
    <div className='fixed inset-0 bg-white z-[90] flex flex-col animate-slide-up'>
      <div className='bg-white px-4 py-4 flex items-center border-b border-gray-100 relative shadow-sm'>
        <button onClick={onClose} className='p-2 -ml-2 hover:bg-gray-100 rounded-full absolute left-4'>
          <ChevronLeft size={24} />
        </button>
      ...
      <div className='p-6'>
        <div className='flex flex-col space-y-6'>
          <div>
            <label className='block text-sm font-bold text-gray-700 mb-2'>新手机号</label>
