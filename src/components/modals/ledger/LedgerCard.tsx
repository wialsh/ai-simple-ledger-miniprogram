...
const COLORS = {
  ...
  gray600: '#4b5563',
  gray900: '#111827',
  primaryLight: '#E0F2F1', // bg-primary-light (approximation)
  primaryDark: '#49807D',
  primary: '#76BDB9',
  red500: '#ef4444',
  red600: '#dc2626',
...
export const LedgerCard: React.FC<LedgerCardProps> = ({ ledger, onClick, onEdit, onDelete, stats }) => {
      ...
      >
        ...
        <View
          style={{
            ...
            boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)',
            flexShrink: 0,
            backgroundColor: '#ffffff', // 需要给 Icon 一个背景色吗？原代码 text-white 可能是指 Icon 颜色，但这里 Icon 组件自己有颜色
          }}
        >
        ...
        <View style={{ flex: 1, minWidth: 0 }}>
          ...
          {stats && (
            ...
            >
              <Text style={{ fontSize: '10px', fontWeight: 500, color: COLORS.gray400 }}>
                预算: {stats?.budget.toLocaleString()}
              </Text>
              <Text style={{ fontSize: '10px', color: COLORS.gray400 }}>•</Text>
              <Text style={{ fontSize: '10px', fontWeight: 500, color: COLORS.gray400 }}>
                支出: {stats?.spent.toLocaleString()}
              </Text>
            </View>
          )}
        </View>
