...
import { View, Text, Image, RootPortal, ScrollView } from '@tarojs/components'; // 1. 引入 Taro 组件
import { Icon } from '@/components/ui/Icon';
import { Switch } from '@/components/ui/Switch'; // 确保 Switch 已适配
...
const COLORS = {
  ...
  red600: '#dc2626',
  green500: '#22c55e',
  yellow100: '#fff9d6', // hover bg for batch action
};
