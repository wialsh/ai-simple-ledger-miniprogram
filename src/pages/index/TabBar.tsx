...
export const TabBar: React.FC<TabBarProps> = ({ active, onChange }) => {
  ...
  return (
    ...
    >
      ...
      {/* 4. 预算 Tab */}
      <View onClick={() => onChange('budget')} style={tabItemStyle}>
        <Icon name='Landmark' size={24} color={getColor('budget')} strokeWidth={active === 'budget' ? 2.5 : 1.5} />
        <Text style={textStyle('budget')}>预算</Text>
      </View>
